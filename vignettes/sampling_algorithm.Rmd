...
[^1]: $f(s, n)$, the number of partitions of $n$ into exactly $s$ parts is more commonly expressed via the related quantity, $p(s, n)$, the number of partitions of $s$ into at most $n$ parts by $f(s, n) = p(s-n, n)$. Early study of $p(s, n)$ was conducted by L. Euler; for an extensive history of the topic, see @Dickson_1919.
